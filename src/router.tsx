...
import LoginPage from './content/overview/Login'; // Renamed local Login to LoginPage
import Signup from './content/overview/Signup';
// import Actions from './content/applications/Transactions/Actions'; // Import your Actions component
...
const routes: RouteObject[] = [
  ...
  // {
  //   path: 'actions', // Define the path for Actions component
  //   element: <Actions /> // Render your Actions component here
  // }
];
